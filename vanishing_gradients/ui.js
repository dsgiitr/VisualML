...
export function loadTrainParametersFromUI() {
  return {
    ...
    numLayers:   Number(document.getElementById('num-layers').value),
    numNeurons:  Number(document.getElementById('num-neurons').value),
    a_f:          document.getElementById('activations_f').value
  };
}
